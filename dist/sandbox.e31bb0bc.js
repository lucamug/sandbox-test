...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/index.elm":[function(require,module,exports) {
(function(scope){
'use strict';
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Here is a counter from elm')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}}}}})}});
...
var _index = require("./src/index.elm");

require("./style.scss");

_index.Elm.Main.init({
  node: document.querySelector("main")
});
},{"./src/index.elm":"src/index.elm","./style.scss":"style.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
